...
import com.ecar.ecarnetfream.publics.entity.WindowSize;
...
//    }
    ...
    public static WindowSize getWindowSize(Context context) {
        if (winSize == null) {
            ...
            winSize.winWidth = metric.widthPixels;
            winSize.winHeight = metric.heightPixels;
        }
        return winSize;
    }
...
//    public static void initTitleLayout(final String title,
//                                       final Activity activity, View.OnClickListener backButtonListener) {
//        try {
//            TextView tv = (TextView) activity.findViewById(R.id.head_title);
//            tv.setText(title);
...
//     * 更新Dialog
//     */
//    public static void showDialog(final ResAppUpdate resUpdate, final Activity activity) {
//        final UpdateDialog dialog = new UpdateDialog(activity);
//        dialog.show();
//        dialog.setCanceledOnTouchOutside(false);
//        dialog.setProgressMsg(activity.getResources().getString(R.string.app_name));
//        dialog.setProgressMsgDes(resUpdate.version_msg_content == null ? "" : resUpdate.version_msg_content);
//        final String url = resUpdate.download_url;//urlTest1;//
//        if (resUpdate.flag == 2) {//是否强制更新 0 否 1 是
//            dialog.hideCustomBtn1();
//            dialog.setButton2OnClickListener(new View.OnClickListener() {
//
//                @Override
//                public void onClick(View v) {
//                    new UpdateManager(activity,
//                            url).startDownloadFile();
//                    dialog.dismiss();
//                }
//            }, "更新", R.drawable.btn_yellow_selector);
//        } else if (resUpdate.existupdate == 1) {//是否存在新版本 1 存在新版本 2 不存在新版本
...
//
//    public static void showPrompt(Activity context, String str, final PromptClickListener listener) {
//        final PromptDialog promptdialog = new PromptDialog(context);
//        promptdialog.show();
//        promptdialog.setButtonOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (listener != null) {
//                    listener.callBack();
...
//            }
//        });
//        Button dialogCal = (Button) promptdialog.findViewById(R.id.prompt_cal);
//        Button dialogbut = (Button) promptdialog.findViewById(R.id.prompt_sub);
//        dialogbut.setBackgroundResource(R.drawable.pub_btn_submit_selector);
//        dialogCal.setVisibility(View.GONE);
//        dialogbut.setText("知道了");
//        TextView tv = (TextView) promptdialog.findViewById(R.id.prompt_text);
//        tv.setText(str);
//    }
...
//     * 按钮是否可点击、背景
//     */
//    public static void setBtnEnableBg(Button btn,boolean isEnable){
//        //设置提交背景
//        btn.setClickable(isEnable);
//            if (isEnable) {
//                btn.setBackgroundResource(R.drawable.pub_btn_submit_selector);
//            } else {
//                btn.setBackgroundResource(R.drawable.pub_btn_submit_press);
//            }
//    }
